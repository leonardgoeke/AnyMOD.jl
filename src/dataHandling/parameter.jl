...
function defineParameter(options::modOptions, report::Array{Tuple,1})
    ...
    expExcExp_tup = (:Exc => :up, :Ts_expSup => :up, :R_from => :up, :R_to => :up, :id => :up, :Ts_expSup => :avg_any, :R_from => :avg_any, :R_to => :avg_any, :id => :avg_any)
    ...
    parDef_dic[:delExc]    = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = 0.0, herit = expExcExp_tup, part = :exc)
    parDef_dic[:delExcDir] = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = 0.0, herit = expExcExp_tup, part = :exc)
    ...
    parDef_dic[:lifeExc]    = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = 50, herit = expExcExp_tup, part = :exc)
    parDef_dic[:lifeExcDir] = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = 50, herit = expExcExp_tup, part = :exc)
    ...
    parDef_dic[:lifeEcoExc]    = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = expExcExp_tup, part = :cost)
    parDef_dic[:lifeEcoExcDir] = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = expExcExp_tup, part = :cost)
    ...
    parDef_dic[:costExpExc]    = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = excExp_tup, part = :cost)
    parDef_dic[:costExpExcDir] = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = excExp_tup, part = :cost)
    ...
    parDef_dic[:rateExpExc]    = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = expExcExp_tup, part = :cost)
    parDef_dic[:rateExpExcDir] = (dim = (:Ts_expSup, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = expExcExp_tup, part = :cost)
    ...
    parDef_dic[:expConvInf] = (dim = (:Ts_exp, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_exp => :avg_any, :Te => :avg_any), part = :lim)
    ...
    parDef_dic[:expStInFix] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full, :id => :sum_full), part = :lim)
    parDef_dic[:expStInInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_exp => :avg_any, :Te => :avg_any, :id => :avg_any),     part = :lim)
    ...
    parDef_dic[:expStOutFix] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full, :id => :sum_full), part = :lim)
    parDef_dic[:expStOutInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_exp => :avg_any, :Te => :avg_any, :id => :avg_any),     part = :lim)
    ...
    parDef_dic[:expStSizeFix] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full, :id => :sum_full), part = :lim)
    parDef_dic[:expStSizeInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_exp => :avg_any, :Te => :avg_any, :id => :avg_any),     part = :lim)

    parDef_dic[:expExcUp]  = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :Exc => :sum_full, :id => :sum_full), part = :lim)
    parDef_dic[:expExcLow] = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_any,  :R_from => :sum_any,  :R_to => :sum_any,  :Exc => :sum_any,  :id => :sum_any),  part = :lim)
    parDef_dic[:expExcFix] = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :Exc => :sum_full, :id => :sum_full), part = :lim)
    parDef_dic[:expExcInf] = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_from => :avg_any, :R_to => :avg_any, :Exc => :avg_any, :id => :avg_any),      part = :lim)

    parDef_dic[:expExcUpDir]  = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :Exc => :sum_full, :id => :sum_full), part = :lim)
    ...
    parDef_dic[:shareExpOutInf] = (dim = (:Ts_disSup, :R_exp, :Te, :C), problem = :top, defVal = nothing, herit = (:Ts_disSup => :up, :R_exp => :up, :Ts_disSup => :avg_full), part = :cost)
    ...
    parDef_dic[:retroStInFix] = (dim = (:Ts_retro, :R_exp, :Ts_expSup_i, :Te_i, :Ts_expSup_j, :Te_j, :id_i, :id_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_exp => :sum_full, :id_i => :sum_full, :Ts_expSup_i => :sum_full, :Te_i => :sum_full, :id_j => :sum_full, :Ts_expSup_j => :sum_full, :Te_j => :sum_full), part = :lim)
    ...
    parDef_dic[:retroStOutFix] = (dim = (:Ts_retro, :R_exp, :Ts_expSup_i, :Te_i, :Ts_expSup_j, :Te_j, :id_i, :id_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_exp => :sum_full, :id_i => :sum_full, :Ts_expSup_i => :sum_full, :Te_i => :sum_full, :id_j => :sum_full, :Ts_expSup_j => :sum_full, :Te_j => :sum_full), part = :lim)
    ...
    parDef_dic[:retroStSizeFix] = (dim = (:Ts_retro, :R_exp, :Ts_expSup_i, :Te_i, :Ts_expSup_j, :Te_j, :id_i, :id_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_exp => :sum_full, :id_i => :sum_full, :Ts_expSup_i => :sum_full, :Te_i => :sum_full, :id_j => :sum_full, :Ts_expSup_j => :sum_full, :Te_j => :sum_full), part = :lim)
    ...
    parDef_dic[:capaConvInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :Ts_expSup => :avg_any),    part = :lim)
    ...
    parDef_dic[:capaStInFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any, :id => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:capaStInInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :id => :avg_any, :Ts_expSup => :avg_any),     part = :lim)
    ...
    parDef_dic[:capaStOutFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any, :id => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:capaStOutInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :id => :avg_any, :Ts_expSup => :avg_any),     part = :lim)
    ...
    parDef_dic[:capaStSizeFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full,  :Ts_disSup =>:avg_any, :id => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:capaStSizeInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any,  :Ts_disSup =>:avg_any, :id => :avg_any, :Ts_expSup => :avg_any),     part = :lim)

    parDef_dic[:capaExcUp]  = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:capaExcLow] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_any,  :Ts_disSup => :avg_any, :Ts_expSup => :sum_any),  part = :lim)
    parDef_dic[:capaExcFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:capaExcInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :avg_any, :R_to => :avg_any, :Exc => :avg_any, :Ts_disSup => :avg_any, :Ts_expSup => :avg_any),   part = :lim)

    parDef_dic[:capaExcUpDir]  = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:capaExcLowDir] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_any,  :Ts_disSup => :avg_any, :Ts_expSup => :sum_any),  part = :lim)
    parDef_dic[:capaExcFixDir] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any, :Ts_expSup => :sum_full), part = :lim)
    ...
    parDef_dic[:insCapaConvInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :Ts_expSup => :avg_any), 	part = :lim)
    ...
    parDef_dic[:insCapaStInFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any, :id => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:insCapaStInInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :id => :avg_any, :Ts_expSup => :avg_any), 	   part = :lim)
    ...
    parDef_dic[:insCapaStOutFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any, :id => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:insCapaStOutInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :id => :avg_any, :Ts_expSup => :avg_any), 	part = :lim)
    ...
    parDef_dic[:insCapaStSizeFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any, :id => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:insCapaStSizeInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :id => :avg_any, :Ts_expSup => :avg_any), 	 part = :lim)
    ...
    parDef_dic[:insCapaExcFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:Ts_disSup => :avg_any, :R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_expSup => :sum_full), part = :lim)
    parDef_dic[:insCapaExcInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:Ts_disSup => :avg_any, :R_from => :avg_any, :R_to => :avg_any, :Exc => :avg_any, :Ts_expSup => :avg_any),   part = :lim)
    ...
    parDef_dic[:mustCapaConvInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te), problem = :both, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :Ts_expSup => :avg_any),  part = :lim)
    ...
    parDef_dic[:mustCapaStOutInf] = (dim = (:Ts_disSup, :Ts_expSup, :R_exp, :Te, :id), problem = :both, defVal = nothing, herit = (:R_exp => :avg_any, :Te => :avg_any, :Ts_disSup => :avg_any, :id => :avg_any, :Ts_expSup => :avg_any),     part = :lim)
    ...
    parDef_dic[:mustExpConvInf] = (dim = (:Ts_exp, :R_exp, :Te), problem = :both, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_exp => :avg_any, :Te => :avg_any),    part = :lim)
    ...
    parDef_dic[:mustExpStOutInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :both, defVal = nothing, herit = (:Ts_exp => :avg_any, :R_exp => :avg_any, :Te => :avg_any, :id => :avg_any),     part = :lim)
    ...
    parDef_dic[:stInToConvCapaInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :cost)
    ...
    parDef_dic[:stOutToStInCapaInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :cost)
    ...
    parDef_dic[:sizeToStOutCapaInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :cost)

    # expansion
    parDef_dic[:stInToConvExpUp]  = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top,  defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:stInToConvExpLow] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top,  defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:stInToConvExpFix] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:stInToConvExpInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :cost)

    parDef_dic[:stOutToStInExpUp]  = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top,  defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:stOutToStInExpLow] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top,  defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:stOutToStInExpFix] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:stOutToStInExpInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :cost)

    parDef_dic[:sizeToStOutExpUp]  = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top,  defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:sizeToStOutExpLow] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top,  defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:sizeToStOutExpFix] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :techSt)
    parDef_dic[:sizeToStOutExpInf] = (dim = (:Ts_exp, :R_exp, :Te, :id), problem = :top, defVal = nothing, herit = (:Te => :up, :Ts_exp => :up, :R_exp => :up), part = :cost)
    ...
    parDef_dic[:useFix] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :scr), problem = :sub, defVal = nothing, herit = upHerit_tup, part = :lim)
    ...
    parDef_dic[:genFix] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :scr), problem = :sub, defVal = nothing, herit = upHerit_tup, part = :lim)
    ...
    parDef_dic[:stExtOutFix] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :sub, defVal = nothing, herit = upHerit_tup,   part = :lim)
    ...
    parDef_dic[:stExtInFix] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :sub, defVal = nothing, herit = upHerit_tup,   part = :lim)
    ...
    parDef_dic[:stIntOutFix] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :sub, defVal = nothing, herit = upHerit_tup,   part = :lim)
    ...
    parDef_dic[:stOutFix] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :sub, defVal = nothing, herit = upHerit_tup,   part = :lim)
    ...
    parDef_dic[:excFix]  =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :Ts_expSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :C => :sum_full, :Exc => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:excFixDir]  =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :Ts_expSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :C => :sum_full, :Exc => :sum_full, :scr => :up), part = :lim)

    parDef_dic[:useExcUp]   =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :Ts_expSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :C => :sum_full, :Exc => :sum_full, :scr => :up), part = :lim)
    parDef_dic[:useExcLow]  =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_any,  :Ts_expSup => :sum_any,  :R_from => :sum_any,  :R_to => :sum_any,  :C => :sum_any,  :Exc => :sum_any, :scr => :up),  part = :lim)
    parDef_dic[:useExcFix]  =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :Ts_expSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :C => :sum_full, :Exc => :sum_full, :scr => :up), part = :lim)

    parDef_dic[:useExcUpDir]   =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :Ts_expSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :C => :sum_full, :Exc => :sum_full, :scr => :up), part = :lim)
    parDef_dic[:useExcLowDir]  =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_any,  :Ts_expSup => :sum_any,  :R_from => :sum_any,  :R_to => :sum_any,  :C => :sum_any,  :Exc => :sum_any, :scr => :up),  part = :lim)
    parDef_dic[:useExcFixDir]  =  (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :Ts_expSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :C => :sum_full, :Exc => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:trdSellFix]  =  (dim = (:Ts_dis, :R_dis, :C, :scr), problem = :sub, defVal = nothing, herit = (:Ts_dis => :sum_full, :R_dis => :sum_full, :C => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:emissionInf]   =  (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :Exc, :M, :id, :scr), problem = :both, defVal = nothing, herit = (:Ts_dis => :up, :Ts_expSup => :up, :R_dis => :up, :C => :up, :Te => :up, :Exc => :up, :M => :up, :id => :up, :scr => :up), part = :lim)
    ...
    parDef_dic[:costFix] = (dim = (:Ts, :R, :Te, :Exc), problem = :top, defVal = nothing, herit = (:Ts => :sum_full, :R => :sum_full, :Te => :sum_full, :Exc => :sum_full), part = :lim)
    ...
    parDef_dic[:costExpConvFix] = (dim = (:Ts_exp, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full), part = :lim)
    ...
    parDef_dic[:costExpStInFix] = (dim = (:Ts_exp, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full), part = :lim)
    ...
    parDef_dic[:costExpStOutFix] = (dim = (:Ts_exp, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full), part = :lim)
    ...
    parDef_dic[:costExpStSizeFix] = (dim = (:Ts_exp, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_exp => :sum_full, :Te => :sum_full), part = :lim)

    parDef_dic[:costExpExcUp]  = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :Exc => :sum_full), part = :lim)
    parDef_dic[:costExpExcLow] = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_any,  :R_from => :sum_any,  :R_to => :sum_any,  :Exc => :sum_any),  part = :lim)
    parDef_dic[:costExpExcFix] = (dim = (:Ts_exp, :R_from, :R_to, :Exc, :id), problem = :top, defVal = nothing, herit = (:Ts_exp => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :Exc => :sum_full), part = :lim)
    ...
    parDef_dic[:costOprConvFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costOprStInFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costOprStOutFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costOprStSizeFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costOprExcFix] = (dim = (:Ts_disSup, :R_from, :R_to, :Exc), defVal = nothing, problem = :top, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costRetroConvFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costRetroStInFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costRetroStOutFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costRetroStSizeFix] = (dim = (:Ts_disSup, :R_exp, :Te), problem = :top, defVal = nothing, herit = (:R_exp => :sum_full, :Te => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costRetroExcFix] = (dim = (:Ts_disSup, :R_from, :R_to, :Exc), problem = :top, defVal = nothing, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any), part = :lim)
    ...
    parDef_dic[:costVarUseFix] = (dim = (:Ts_disSup, :R_dis, :Te, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :Te => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costVarGenFix] = (dim = (:Ts_disSup, :R_dis, :Te, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :Te => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costVarStInFix] = (dim = (:Ts_disSup, :R_dis, :Te, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :Te => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costVarStOutFix] = (dim = (:Ts_disSup, :R_dis, :Te, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :Te => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costVarConvInFix] = (dim = (:Ts_disSup, :R_dis, :Te, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :Te => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costVarConvOutFix] = (dim = (:Ts_disSup, :R_dis, :Te, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :Te => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costVarExcFix]  =  (dim = (:Ts_disSup, :R_from, :R_to, :Exc, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_from => :sum_full, :R_to => :sum_full, :Exc => :sum_full, :scr => :up),  part = :lim)
    ...
    parDef_dic[:costEmFix] = (dim = (:Ts_disSup, :R_dis, :C, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :C => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costCrtFix] = (dim = (:Ts_disSup, :R_dis, :C, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :C => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costLssFix] = (dim = (:Ts_disSup, :R_dis, :C, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :C => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costTrdBuyFix] = (dim = (:Ts_disSup, :R_dis, :C, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :C => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:costTrdSellFix] = (dim = (:Ts_disSup, :R_dis, :C, :scr), problem = :sub, defVal = nothing, herit = (:Ts_disSup => :sum_full, :R_dis => :sum_full, :C => :sum_full, :scr => :up), part = :lim)
    ...
    parDef_dic[:avaStIn]   = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :both,  defVal = 1.0, herit = (:Ts_expSup => :up, :Ts_dis => :up, :R_dis => :up, :scr => :up, :C => :up, :id => :up, :Te => :up, :Ts_dis => :avg_any, :R_dis => :avg_any), part = :techSt,   techPre = (preset = :carrierSt, mode = (:stIn, :stOut, :stLvl)))
    ...
    parDef_dic[:avaStSize] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :both,  defVal = 1.0, herit = (:Ts_expSup => :up, :Ts_dis => :up, :R_dis => :up, :C => :up, :id => :up, :Te => :up, :Ts_dis => :avg_any, :R_dis => :avg_any), part = :techSt,   techPre = (preset = :carrierSt, mode = (:stIn, :stOut, :stLvl)))
    ...
    parDef_dic[:effStIn]  = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :M, :id, :scr), problem = :both, defVal = 1.0, herit = (:Ts_expSup => :up, :Ts_dis => :up, :id => :up, :R_dis => :up, :scr => :up, :Te => :up, :Ts_dis => :avg_any, :R_dis => :avg_any, :C => :up), part = :techSt, techPre = (preset = :carrierSt, mode = (:stIn, :stOut, :stLvl)))
    ...
    parDef_dic[:effStInterIn]  = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id, :scr), problem = :both, defVal = 1.0, herit = (:Ts_expSup => :up, :Ts_dis => :up, :id => :up, :R_dis => :up, :scr => :up, :Te => :up, :Ts_dis => :avg_any, :R_dis => :avg_any, :C => :up), part = :techSt, techPre = (preset = :carrierSt, mode = (:stIn, :stOut, :stLvl)))
    parDef_dic[:effStInterOut] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id, :scr), problem = :both, defVal = 1.0, herit = (:Ts_expSup => :up, :Ts_dis => :up, :id => :up, :R_dis => :up, :scr => :up, :Te => :up, :Ts_dis => :avg_any, :R_dis => :avg_any, :C => :up), part = :techSt, techPre = (preset = :carrierSt, mode = (:stIn, :stOut, :stLvl)))
    ...
    parDef_dic[:costStLvlLss] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id),           problem = :both, defVal = nothing, herit = (:Ts_expSup => :up, :C => :up, :Ts_dis => :avg_any, :R_dis => :sum_any, :Te => :up, :id => :up),                                             part = :cost, techPre = (preset = :carrierSt, mode = tuple()))

    # reference storage level and deviation costs
    parDef_dic[:stLvlRefMonte]     = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id),      problem = :sub,  defVal = 0.0     , herit = (:Ts_expSup => :up, :C => :up, :Ts_dis => :up, :R_dis => :sum_any, :Te => :up, :id => :up),                                             part = :cost, techPre = (preset = :carrierSt, mode = tuple()))
    parDef_dic[:costStLvlRefMonte] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id),      problem = :sub,  defVal = nothing , herit = (:Ts_expSup => :up, :C => :up, :Ts_dis => :up, :R_dis => :sum_any, :Te => :up, :id => :up),                                             part = :cost, techPre = (preset = :carrierSt, mode = tuple()))
    ...
    parDef_dic[:desFac] = (dim = (:Ts_expSup, :Ts_disSup, :R_dis, :C, :Te, :id), problem = :both, defVal = nothing, herit = (:Ts_expSup => :up, :Ts_disSup => :up, :R_dis => :up), part = :techConv)
    ...
    excHeritUse_tup = (:Ts_expSup => :up, :Ts_dis => :up, :R_from => :up, :R_to => :up, :scr => :up, :R_from => :avg_any, :R_to => :avg_any, :Exc => :up, :Ts_dis => :avg_any)
    ...
    parDef_dic[:useExc]     = (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = excHeritUse_tup, part = :exc)
    ...
    parDef_dic[:useExcDir]     = (dim = (:Ts_dis, :Ts_expSup, :R_from, :R_to, :C, :Exc, :scr), problem = :sub, defVal = nothing, herit = excHeritUse_tup, part = :exc)
...
function matchLimitParameter(allVar_df::DataFrame, par_obj::ParElement, anyM::anyModel)
    ...
    if !isempty(noMtcPar_arr)
        ...
        # find ancestors of entries in variables that also occur in remaining parameter data (= potential cases of variable aggregation)
        aggEtr_dic = Dict(x => Symbol(split(string(x), "_")[1]) |> (w -> unique(aggPar_obj.data[!,x]) |> (z -> Dict(y => w == :id ? Int[] : intersect(z, union([y], getAncestors(y, anyM.sets[w], :int, 0))) for y in unique(grpVar_df[!,x])))) for x in agg_tup)
        
        # create dataframe of potential limiting constraints by replacing and flattening with entries of dictionary
        potLim_df  = select(grpVar_df, Not([:var]))
        rplMad_boo = false
        for u in keys(aggEtr_dic)
            if !all(isempty.(getindex.(collect(aggEtr_dic[u]), 2)))
                potLim_df[!,u] = map(x -> aggEtr_dic[u][x] |> (y -> isempty(y) ? [x] : y), potLim_df[!,u])
                potLim_df = flatten(potLim_df, u)
                rplMad_boo = true
            end
        end
