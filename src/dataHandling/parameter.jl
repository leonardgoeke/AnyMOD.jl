...
function defineParameter(options::modOptions, report::Array{Tuple,1})
    ...
    parDef_dic[:capaExcFix] = (dim = (:Ts_disSup, :Ts_expSup, :R_from, :R_to, :Exc), defVal = nothing, problem = :top, herit = (:R_from => :sum_any, :R_to => :sum_any, :Exc => :sum_full, :Ts_disSup => :avg_any, :Ts_expSup => :sum_full), part = :lim)
    ...
    parDef_dic[:stLvlRefMonte]     = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id),      problem = :sub,  defVal = nothing, herit = (:Ts_expSup => :up, :C => :up, :Ts_dis => :avg_any, :R_dis => :sum_any, :Te => :up, :id => :up),                                             part = :cost, techPre = (preset = :carrierSt, mode = tuple()))
    parDef_dic[:costStLvlRefMonte] = (dim = (:Ts_dis, :Ts_expSup, :R_dis, :C, :Te, :id),      problem = :sub,  defVal = nothing, herit = (:Ts_expSup => :up, :C => :up, :Ts_dis => :avg_any, :R_dis => :sum_any, :Te => :up, :id => :up),                                             part = :cost, techPre = (preset = :carrierSt, mode = tuple()))
