...
function defineParameter(options::modOptions,report::Array{Tuple,1})
    ...
    stRetro_tup = (:Ts_retro => :up, :R_exp => :up, :C_i => :up, :Ts_expSup_i => :up, :Te_i => :up, :C_j => :up, :Ts_expSup_j => :up, :Te_j => :up, :Ts_retro => :avg_any, :R_exp => :avg_any, :C_i => :avg_any, :Ts_expSup_i => :avg_any, :Te_i => :avg_any, :C_j => :avg_any, :Ts_expSup_j => :avg_any, :Te_j => :avg_any)
    excRetro_tup = (:Ts_retro => :up, :R_a => :up, :R_b => :up, :Ts_expSup_i => :up, :Exc_i => :up, :Ts_expSup_j => :up, :Exc_j => :up, :Ts_retro => :avg_any, :R_a => :avg_any, :R_b => :avg_any, :Ts_expSup_i => :avg_any, :Exc_i => :avg_any, :Ts_expSup_j => :avg_any, :Exc_j => :avg_any)
    ...
    parDef_dic[:lifeRetroStIn]   = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 20.0, herit = stRetro_tup,   part = :techSt)
    parDef_dic[:lifeRetroStOut]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 20.0, herit = stRetro_tup,   part = :techSt)
    parDef_dic[:lifeRetroStSize] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 20.0, herit = stRetro_tup,   part = :techSt)
    parDef_dic[:lifeRetroExc]    = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j),       problem = :top, defVal = 50.0, herit = excRetro_tup,   part = :exc)
    ...
    parDef_dic[:creditRetroStIn]   = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 1.0, herit = stRetro_tup,   part = :techSt)
    parDef_dic[:creditRetroStOut]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 1.0, herit = stRetro_tup,   part = :techSt)
    parDef_dic[:creditRetroStSize] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 1.0, herit = stRetro_tup,   part = :techSt)
    parDef_dic[:creditRetroExc]    = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j),       problem = :top, defVal = 1.0, herit = excRetro_tup,   part = :exc)
    ...
    parDef_dic[:lifeEcoRetroStIn]   = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup,   part = :obj)
    parDef_dic[:lifeEcoRetroStOut]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup,   part = :obj)
    parDef_dic[:lifeEcoRetroStSize] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup,   part = :obj)
    parDef_dic[:lifeEcoRetroExc]    = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j),       problem = :top, defVal = nothing, herit = excRetro_tup,  part = :obj)
    ...
    parDef_dic[:costRetroStIn]   = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup, part = :obj)
    parDef_dic[:costRetroStOut]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup, part = :obj)
    parDef_dic[:costRetroStSize] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup, part = :obj)
    parDef_dic[:costRetroExc]    = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j),       problem = :top, defVal = nothing, herit = excRetro_tup, part = :obj)
    ...
    parDef_dic[:rateRetroStIn]   = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup, part = :obj)
    parDef_dic[:rateRetroStOut]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup, part = :obj)
    parDef_dic[:rateRetroStSize] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = stRetro_tup, part = :obj)
    parDef_dic[:rateRetroExc]    = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j),       problem = :top, defVal = nothing, herit = excRetro_tup, part = :obj)
    ...
    parDef_dic[:facRetroStIn]   = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 1.0, herit = stRetro_tup, part = :obj)
    parDef_dic[:facRetroStOut]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 1.0, herit = stRetro_tup, part = :obj)
    parDef_dic[:facRetroStSize] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = 1.0, herit = stRetro_tup, part = :obj)
    parDef_dic[:facRetroExc]    = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j),       problem = :top, defVal = 1.0, herit = excRetro_tup, part = :obj)
    ...
    parDef_dic[:retroStInUp]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_exp => :sum_full, :C_i => :sum_full, :Ts_expSup_i => :sum_full, :Te_i => :sum_full, :C_j => :sum_full, :Ts_expSup_j => :sum_full, :Te_j => :sum_full), part = :lim)
    parDef_dic[:retroStInLow] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_exp => :sum_any, :C_i => :sum_any, :Ts_expSup_i => :sum_any, :Te_i => :sum_any, :C_j => :sum_any, :Ts_expSup_j => :sum_any, :Te_j => :sum_any),  part = :lim)
    parDef_dic[:retroStInFix] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_exp => :sum_any, :C_i => :sum_any, :Ts_expSup_i => :sum_any, :Te_i => :sum_any, :C_j => :sum_any, :Ts_expSup_j => :sum_any, :Te_j => :sum_any),  part = :lim)

    parDef_dic[:retroStOutUp]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_exp => :sum_full, :C_i => :sum_full, :Ts_expSup_i => :sum_full, :Te_i => :sum_full, :C_j => :sum_full, :Ts_expSup_j => :sum_full, :Te_j => :sum_full), part = :lim)
    parDef_dic[:retroStOutLow] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_exp => :sum_any, :C_i => :sum_any, :Ts_expSup_i => :sum_any, :Te_i => :sum_any, :C_j => :sum_any, :Ts_expSup_j => :sum_any, :Te_j => :sum_any),  part = :lim)
    parDef_dic[:retroStOutFix] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_exp => :sum_any, :C_i => :sum_any, :Ts_expSup_i => :sum_any, :Te_i => :sum_any, :C_j => :sum_any, :Ts_expSup_j => :sum_any, :Te_j => :sum_any),  part = :lim)

    parDef_dic[:retroStSizeUp]  = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_exp => :sum_full, :C_i => :sum_full, :Ts_expSup_i => :sum_full, :Te_i => :sum_full, :C_j => :sum_full, :Ts_expSup_j => :sum_full, :Te_j => :sum_full), part = :lim)
    parDef_dic[:retroStSizeLow] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_exp => :sum_any, :C_i => :sum_any, :Ts_expSup_i => :sum_any, :Te_i => :sum_any, :C_j => :sum_any, :Ts_expSup_j => :sum_any, :Te_j => :sum_any),  part = :lim)
    parDef_dic[:retroStSizeFix] = (dim = (:Ts_retro, :R_exp, :C_i, :Ts_expSup_i, :Te_i, :C_j, :Ts_expSup_j, :Te_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_exp => :sum_any, :C_i => :sum_any, :Ts_expSup_i => :sum_any, :Te_i => :sum_any, :C_j => :sum_any, :Ts_expSup_j => :sum_any, :Te_j => :sum_any),  part = :lim)

    parDef_dic[:retroExcUp]  = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_full, :R_a => :sum_full, :R_b => :sum_full, :Ts_expSup_i => :sum_full, :Exc_i => :sum_full, :Ts_expSup_j => :sum_full, :Exc_j => :sum_full), part = :lim)
    parDef_dic[:retroExcLow] = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_a => :sum_any,  :R_b => :sum_any,  :Ts_expSup_i => :sum_any, :Exc_i => :sum_any, :Ts_expSup_j => :sum_any, :Exc_j => :sum_any),  part = :lim)
    parDef_dic[:retroExcFix] = (dim = (:Ts_retro, :R_a, :R_b, :Ts_expSup_i, :Exc_i, :Ts_expSup_j, :Exc_j), problem = :top, defVal = nothing, herit = (:Ts_retro => :sum_any,  :R_a => :sum_any,  :R_b => :sum_any,  :Ts_expSup_i => :sum_any, :Exc_i => :sum_any, :Ts_expSup_j => :sum_any, :Exc_j => :sum_any),  part = :lim)
